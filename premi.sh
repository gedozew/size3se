...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}‎✧═══════════════════════✧${NC}"
echo -e "  Welcome To CyberSufi  ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}CyberSufi® ${NC}${YELLOW}(${NC} ${green} Abu'Rifat Tunnel${NC}${YELLOW})${NC}"
echo -e " © Recode Mod CyberSufi${YELLOW}(${NC} 2025 ${YELLOW})${NC}"
echo -e "${YELLOW}‎✧═══════════════════════✧${NC}"
echo ""
sleep 2
###### IZIN SC 
...
restart_system() {
    ...
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/gedozew/Regist/main/afk | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/aburifat76"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/aburifat"}]]}'
...
wget raw.githubusercontent.com/Aburifat-almalakani/vip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
